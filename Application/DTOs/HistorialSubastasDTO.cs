...
{
    /// <summary>
    /// Clase DTO que se encarga de encapsular la información necesaria para mostrar el historial de pujas de una subasta con su detalle desde el Microservicio Subastas
    /// </summary>
